...
namespace Collective\Html {
     ...
     */        class FormFacade {
        ...
        {            //Method inherited from \Collective\Html\FormBuilder         
                        /** @var \App\Helpers\Macros\Macros $instance */
         ...
         *
         * @param \Illuminate\Contracts\Session\Session $session
         * @return \App\Helpers\Macros\Macros 
         * @static 
         ...
         */        public static function mixin($mixin, $replace = true)
        {            //Method inherited from \Collective\Html\FormBuilder         
                        \App\Helpers\Macros\Macros::mixin($mixin, $replace);
        }
                    /**
         * Checks if macro is registered.
         *
         ...
         */        public static function flushMacros()
        {            //Method inherited from \Collective\Html\FormBuilder         
                        \App\Helpers\Macros\Macros::flushMacros();
        }
                    /**
         * Dynamically handle calls to the class.
         *
         ...
         * @return string 
         * @static 
         */        public static function aaaText($name, $value = null, $options = [], $errors = null, $formGroupClasses = null)
        {
                        /** @var \App\Helpers\Macros\Macros $instance */
                        return $instance->aaaText($name, $value, $options, $errors, $formGroupClasses);
        }
                    /**
         * 
         *
         * @static 
         */        public static function aaaTextarea($name, $value = null, $options = [])
        {
                        /** @var \App\Helpers\Macros\Macros $instance */
                        return $instance->aaaTextarea($name, $value, $options);
        }
            }
            /**
     * 
